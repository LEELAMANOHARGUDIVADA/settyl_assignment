    ...
    <div>
        {isLoading ? (
            ...
            <div className='flex items-center gap-10  py-2'>
                <div className='flex'>
                    {profile?.profileUrl ? <img src={`${SERVERURL/${profile?.profileUrl}</img>}`} alt="" className='w-12 h-12 object-cover object-center rounded-full' /> : <img src={img} alt="" className='w-12' />
